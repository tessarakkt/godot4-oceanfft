...
func _enter_tree():
	...
	add_custom_type("BuoyancyProbe3D", "Marker3D", preload("res://addons/tessarakkt.oceanfft/components/BuoyancyProbe3D.gd"), preload("res://addons/tessarakkt.oceanfft/icons/BuoyancySphere3D.svg"))
